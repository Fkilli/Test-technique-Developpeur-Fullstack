    ...
    <div class="resize">
        <nav>
            <ul>
                ...
                <li><a href="#">à propos de l'oeuvre</a></li>
                <li><a href="#">Artiste</a></li>
                <li><a href="#">Autres oeuvres</a></li>
            </ul>
        </nav>

        <div id="artSection">
            <main>
                <div id="artSelectorAndMainArt">

                <div class="informationSection">
                <div>
                    <h1>Jeune fille à la perle, 2021</h1>
                    <p>
                ...
                <div>
                    ...
                    <ul>
                        <li>Oeuvre Original</li>
                        <li>Vendu avec un certificat d'authenticité</li>
                        <li>Livraison sous 7 jours en moyenne</li>
                        <li>Frais de livraison GRATUIT en Europe</li>
                        <li>Retours GRATUIT 14 jours après récepetion</li>
                    </ul>

                    <div class="informationSlider">
                        <span class="selectedInformationSlider" >A propos <br> de l'oeuvre</span>
                        <span>Paiement</span>
                        <span>Livraison</span>
                        <span>Retour</span>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="aboutArtDescription">
                            <p>Artiste de l’image Holly Watt est une photographe française. Elle a eu une enfance riche en voyages et en découvertes ce qui l’a rendue à l’affût de toutes sortes d’émotions. Elle découvre la photographie pendant son adolescence et commence à faire ses premières photos en argentique.</p>
                    ...
                    <div class="artSelector">
                        ...
                        <div>
                            ...
                            <img src="./app/assets/artPictures/listPicture (3)" alt="">
                            <img src="./app/assets/artPictures/listPicture (4)" alt="">
                            <img src="./app/assets/artPictures/listPicture (5)" alt="">
                            <img src="./app/assets/artPictures/listPicture (6)" alt="">
                            <img src="./app/assets/artPictures/listPicture (7)" alt="">
                            <a href="#">Voir plus dans mon album</a>
                        </div>
                    </div>
                    ...
                    <span class="responsiveAuthor">Emmanuelle Martin, FRANCE</span>
            ...
            <div class="informationSection">
                <div>
                    <h1>Jeune fille à la perle, 2021</h1>
                    <h2>Emmanuelle <span>Martin</span>, France</h2>
                    <p>
                        Médium: <span class="answer">Peinture</span><br>
                        N'Série: <span class="answer">. / . <span class="grayInformation">ou Oeuvre UNIQUE</span></span><br>
                ...
                <div>
                    ...
                    <div class="informationSlider">
                        <span class="yellowInformation">A propos <br> de l'oeuvre</span>
                        <span>Paiement</span>
                        <span class="selectedInformationSlider">Livraison</span>
                        <span>Retour</span>
                    </div>

                    <div>
                        <ul class="informationMarginUl">
                            <li>Frais de livraison GRATUIT en Europe</li>
                            <li>Livraison sous 7 jours en moyenne</li>
                            <li>Consulter les questions fréquentes (FAQ) <br><span class="redInformation">(Non à ajouter)</span></li>
                            <li>Retours GRATUIT 14 jours apèrs récepetion</li>
                        </ul>
                    </div>
        ...
        <section id="authorSection">
            <div class="resume">
                <span><strong>Résumé</strong></span>
                <ul>
                    <li>Artiste émergent</li>
                    <li>Artiste prometteur à investir</li>
                    <li>Rayonnement national</li>
                    <li>Article de presse</li>
                    <li>Best Seller</li>
                </ul>
            </div>
